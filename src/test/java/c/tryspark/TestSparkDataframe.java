...
import tryspark.SparkDataframe;

/**
 * Unit test for Spark Dataframe.
 */
...
public class TestSparkDataframe {
    ...
    public void test_Task51_1() {
        ...
        List<String> actuals = SparkDataframe.task_51(df).collectAsList().stream()
    ...
    public void test_Task52_1() {
        ...
        List<String> actuals = SparkDataframe.task_52(df).collectAsList().stream()
